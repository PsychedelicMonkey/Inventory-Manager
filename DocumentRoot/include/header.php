        ...
        <div class="navbar">
            ...
            <?php
                ...
                $items = array(
                    ...
                    array('Vendors', 'diamond', '/inventory/landing_page.php?attr=vendor'),
                    array('Categories', 'book', '/inventory/landing_page.php?attr=category'),
                    array('Products', 'tags'),
                    array('Stores', 'shopping-bag', '/inventory/landing_page.php?attr=store'),
                    array('Orders', 'truck'),
